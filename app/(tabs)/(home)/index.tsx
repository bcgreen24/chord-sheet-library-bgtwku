    ...
    try {
      ...
      if (result.assets && result.assets.length > 0) {
        ...
        if (!isValidChordSheet(content)) {
          if (Platform.OS === 'web') {
            window.alert('The selected file does not appear to be a valid chord sheet.');
          } else {
            Alert.alert(
              'Invalid File',
        ...
        if (Platform.OS === 'web') {
          window.alert(`Successfully imported "${newSheet.title}"`);
        } else {
          Alert.alert(
            'Import Successful',
      ...
      if (Platform.OS === 'web') {
        window.alert('Failed to import chord sheet. Please try again.');
      } else {
        Alert.alert(
          'Import Failed',
